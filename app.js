...
// // ====== MongoDB Connection ======
// const dbURI = "mongodb+srv://hanynan:hanynan@hanyscluster.xlpdssw.mongodb.net/Restaurant?retryWrites=true&w=majority";

// // Check if DB_URI is defined
// if (!dbURI) {
//   console.error('❌ DB_URI is not defined! Please add it in Environment Variables.');
//   process.exit(1); // توقف التشغيل لو DB_URI ناقص
// }
